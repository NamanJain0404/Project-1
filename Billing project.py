...
bill_num=random.randint(100,999)
...
root.iconbitmap('C:\HARSH PROGRAMING\PYTHON\Bill\icon.ico')
...
total_button=Button(button_frame,text='Total',font=('times new roman',15,'bold'),fg='white',bg='gray20',bd=2,width=8,relief= RAISED,command=total)
total_button.grid(row=0,column=0,pady=25,padx=15)

bill_button=Button(button_frame,text='Bill',font=('times new roman',15,'bold'),fg='white',bg='gray20',bd=2,width=8,relief= RAISED,command=bill_area)
bill_button.grid(row=0,column=1,pady=25,padx=15)

email_button=Button(button_frame,text='E-mail',font=('times new roman',15,'bold'),fg='white',bg='gray20',bd=2,width=8,relief= RAISED,command=email_bill)
email_button.grid(row=0,column=2,pady=25,padx=15)

print_button=Button(button_frame,text='Print',font=('times new roman',15,'bold'),fg='white',bg='gray20',bd=2,width=8,relief= RAISED,command=print_bill)
print_button.grid(row=0,column=3,pady=25,padx=15)

clear_button=Button(button_frame,text='Clear',font=('times new roman',15,'bold'),fg='white',bg='gray20',bd=2,width=8,relief= RAISED,command=clear_bill)
